  ...
  return (
    <>
      <div>
        ...
        <input style={itemArray.isEditable ? { textDecoration: 'line-through' } : { textDecoration: 'none' }} type="text" value={listName} onChange={(e) => setListName(e.target.value)} readOnly={itemArray.isUpdatable} size="16" />
